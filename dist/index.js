...
function bankAccountDemo() {
    ...
    account.withdraw(5_000_000); // yetarli mablag' yo'q
...
function studentsDemo() {
    ...
    const alice = new Student("Alisher");
    alice.addMark(85);
    alice.addMark(90);
    alice.addMark(78);
    const bob = new Student("Bobur");
    bob.addMark(95);
    bob.addMark(88);
    bob.addMark(92);
...
function transportDemo() {
    ...
    const vehicles = [new Car(), new Bus()];
    for (const vehicle of vehicles) {
        vehicle.move();
        vehicle.stop();
    }
...
function employeeDemo() {
    ...
    const employees = [
        new FullTimeEmployee("Aziz", 5000000),
        new PartTimeEmployee("Malika", 30000, 80),
    ];
